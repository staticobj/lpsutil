...
class StockMetrics extends ElementDataAccess {
    ...
    addMetricCard(metricCard) {
        ...
        let addRowInput = (id, name, type, value) => {
            ...
            uiTableCol1.className = 'ui-table-cell ui-table-cell-50';
            uiTableCol1.innerText = name;
            uiTableRow.appendChild(uiTableCol1);
            uiTableCol2.className = 'ui-table-cell ui-table-cell-50';
            switch(type) {
                case 'number':
        ...
        uiWhitespace.className = 'ui-metric-card-whitespace';
        ...
        uiTableCol1TaskLunch.className = 'ui-table-cell ui-table-cell-50';
        uiTableCol1TaskLunch.innerText = "Lunch";
        uiTableRow1.appendChild(uiTableCol1TaskLunch);
        uiTableCol2TaskLunch.className = 'ui-table-cell ui-table-cell-50';
        ...
        uiTableCol1Cph.className = 'ui-table-cell ui-table-cell-50';
        uiTableCol1Cph.innerText = "CPH";
        uiTableRow3.appendChild(uiTableCol1Cph);
        uiTableCol2Cph.className = 'ui-table-cell ui-table-cell-50';
